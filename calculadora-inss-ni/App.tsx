...
export default function App() {
  ...
  const calcularDescuentos = () => {
    ...
    if (salarioNetoAnual <= 100000) {
      ...
      irAnual = (100000 * 0.15) + ((salarioNetoAnual - 200000) * 0.20);
    } else if (salarioNetoAnual <= 500000) {
      irAnual = (100000 * 0.15) + (150000 * 0.20) + ((salarioNetoAnual - 350000) * 0.25);
    } else {
      irAnual = (100000 * 0.15) + (150000 * 0.20) + (150000 * 0.25) + ((salarioNetoAnual - 500000) * 0.30);
    }
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      {mostrarResultados && (
        <View style={styles.resultadosContainer}>
          ...
          <View style={styles.resultadoItem}>
            ...
            <Text style={[styles.resultadoValor, styles.salarioNeto]}>C$ {salarioNeto.toFixed(2)}</Text>
          </View>
      ...
      <View style={styles.infoContainer}>
        ...
        <Text style={styles.infoTexto}>- IR: Se calcula sobre el salario anual después del INSS</Text>
        <Text style={styles.infoTexto}>  • Hasta C$100,000: 0%</Text>
        <Text style={styles.infoTexto}>  • C$100,001 - C$200,000: 15% sobre el excedente</Text>
        <Text style={styles.infoTexto}>  • C$200,001 - C$350,000: C$15,000 + 20% sobre excedente de C$200,000</Text>
        <Text style={styles.infoTexto}>  • C$350,001 - C$500,000: C$45,000 + 25% sobre excedente de C$350,000</Text>
        <Text style={styles.infoTexto}>  • Más de C$500,000: C$82,500 + 30% sobre excedente de C$500,000</Text>
      </View>
